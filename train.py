...
from utils import PLDA_target_to_source_np
...
class Trainer(BaseTrainer):
    ...
    def _step_target(self, epoch, batch_target, batch_source,
        ...
        frame1=PLDA_target_to_source_np(frames1,image,L=0.1)
    ...
    def train_epoch(self, epoch):
        ...
        for i, (batch_source, batch_target) in enumerate(zip(self.loader_source, \
            ...
            if self.cfg.MODEL.BASELINE:
                ...
                losses, _ = self.step_target(epoch, batch_target, batch_source,
                                                 update_teacher=update_teacher, \
                                                 save_batch=save_batch, \
                                                 tag="train_target")
